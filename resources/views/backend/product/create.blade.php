            ...
            <form method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="inputTitle" type="text" name="prod_name" placeholder="Enter Product Name"
                        value="{{ old('prod_name') }}" class="form-control" required>
                    @error('prod_name')
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="short_desc" name="short_desc" required>{{ old('short_desc') }}</textarea>
                    @error('short_desc')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="sale_price" type="number" name="sale_price" min="0" placeholder="Enter Sale Price"
                        value="{{ old('sale_price') }}" class="form-control" required>
                    @error('sale_price')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="IGI_certificate" type="text" name="IGI_certificate" placeholder="IGI Certificate Link"
                        value="{{ old('IGI_cert') }}" class="form-control" required>
                    @error('sku')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="IGI_certificate" class="col-form-label">Document Number<span
                            class="text-danger">*</span></label>
                    <input id="document_number" type="text" name="document_number" placeholder="document_number"
                        value="{{ old('document_number') }}" class="form-control" required>
                    ...
                    <div class="row">
                        @foreach ($attributes as $attribute => $value)
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label
                                        for="{{ str_replace(' ', '_', strtolower($attribute)) }}">{{ $attribute }}</label>
                                    <input type="text" class="form-control" name="attributes[{{ $attribute }}]"
                                        id="{{ str_replace(' ', '_', strtolower($attribute)) }}"
                                        value="{{ old('attributes.' . $attribute, $value) }}" required>
                                </div>
                            </div>
